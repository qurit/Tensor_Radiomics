...
features_csv = 'features/standard_features.csv'
...
for train_index, test_index in train_test_skf.split(X, y):
    ...
    for model_name, model in models.items():
        ...
        if (model_name!='knn') & ((fs_model_name=='rfe') | (fs_model_name=='selectk')):  # knn doesnt have coef
...
results_df.to_csv(f'results/baseline_ridge_{fs_model_name}_results.csv', index=False)
...
with open(f'results/baseline_{fs_model_name}_feats.csv', 'w') as csvfile:
